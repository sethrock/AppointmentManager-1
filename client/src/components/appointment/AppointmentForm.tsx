  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 bg-background/60 border border-border rounded-lg shadow-lg">
        ...
        <div className="form-section mb-8">
          <h3 className="form-section-title">Appointment Location</h3>
        ...
        <div className="form-section mb-8">
          <h3 className="form-section-title">Appointment Date/Time</h3>
        ...
        <div className="form-section mb-8">
          ...
          <h4 className="section-header">Expenses</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <FormField
              control={form.control}
              name="travelExpense"
